...
A mini project to change the background color of a webpage. Switch between colors with a click of a button or automatically cycle through them.

## Features
- Change background color on button click
- Optional automatic color cycling
- Easy to customize with your own colors
